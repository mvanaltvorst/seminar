...
filepath = f"../../models/mucsvss_coreinf_model_intra_continent_{args.num_particles}_{'stochastic' if args.stochastic_seasonality else 'deterministic'}_{'all' if args.countries == 'all' else args.countries}.pkl"
...
df_inflation = read_inflation(mergeable_format=True, sheet_name = "ccpi_q").reset_index()
