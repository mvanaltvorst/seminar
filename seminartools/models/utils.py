...
def h_period_ahead_forecast(model: BaseModel, data: pd.DataFrame, start_date: str, h: int = 1):
    """
    ...
    # Split data by countries if applicable
    countries = data[model.country_column].unique()
